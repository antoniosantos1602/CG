...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        f3.add(this.scene, 'ambientR', 0.0, 1.0).name('Red');
        f3.add(this.scene, 'ambientG', 0.0, 1.0).name('Green');
        f3.add(this.scene, 'ambientB', 0.0, 1.0).name('Blue');
        f3.add(this.scene, 'ambientA', 0.0, 1.0).name('Alpha');
