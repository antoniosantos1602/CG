...
export class MyScene extends CGFscene {
    ...
    initLights() {
        this.setGlobalAmbientLight(this.ambientR, this.ambientG, this.ambientB, this.ambientA);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.92, 0.64, 0.51, 1.0);
        this.material4.setDiffuse(1, 0.64, 0.51, 1);
        this.material4.setSpecular(0, 0, 0, 0.1);
