...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.texture = new CGFtexture(this, "textures/waterMap.jpg");
		this.appearance.setTexture(this.texture);
		this.appearance.setTextureWrap('REPEAT', 'REPEAT');

		//this.texture2 = new CGFtexture(this, "textures/FEUP.jpg");
		this.texture2 = new CGFtexture(this, "textures/waterTex.jpg");
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/a.vert", "shaders/a.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/b.frag"),
	...
	update(t) {
		...
		else if (this.selectedExampleShader == 9)
