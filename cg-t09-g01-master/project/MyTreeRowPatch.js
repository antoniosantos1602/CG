...
export class MyTreeRowPatch extends CGFobject {
    ...
    initBuffers(){
		...
		this.scene.treeTextureApp3.setTexture(this.scene.treeTexture3);
    ...
    display(){
        ...
        this.scene.pushMatrix();
        //this.scene.translate(....);
        this.scene.translate(this.x + 0, this.y + 0, this.z + 10);
        this.scene.scale(scaleX,scaleY,scaleZ);
        this.apps[1].apply();
        this.scene.billboard.display();
        this.scene.popMatrix();
        ...
        this.scene.pushMatrix();
        //this.scene.translate(....);
        this.scene.translate(this.x + 0,this.y+5,this.z - 20);
        this.scene.scale(scaleX,scaleY,scaleZ);
        this.apps[2].apply();
        this.scene.billboard.display();
        this.scene.popMatrix();
        ...
        this.scene.pushMatrix();
        //this.scene.translate(....);
        this.scene.translate(this.x+20, this.y + 0, this.z + 44);
        this.scene.scale(scaleX,scaleY,scaleZ);
        this.apps[3].apply();
        this.scene.billboard.display();
        this.scene.popMatrix();
        ...
        this.scene.pushMatrix();
        //this.scene.translate(....);
        this.scene.translate(this.x+20,this.y+ 10, this.z -32);
        this.scene.scale(scaleX,scaleY,scaleZ);
        this.apps[4].apply();
        this.scene.billboard.display();
        this.scene.popMatrix();
        ...
        this.scene.pushMatrix();
        //this.scene.translate(....);
        this.scene.translate(this.x,this.y + 5,this.z - 50);
        this.scene.scale(scaleX,scaleY,scaleZ);
        this.apps[5].apply();
        this.scene.billboard.display();
        this.scene.popMatrix();
